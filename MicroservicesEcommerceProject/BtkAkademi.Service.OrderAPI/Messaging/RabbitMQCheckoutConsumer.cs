...
using BtkAkademi.Service.OrderAPI.RabbitMQSender;
using BtkAkademi.Service.OrderAPI.Repository;
using RabbitMQ.Client.Events;
using RabbitMQ.Client;
using System.Text;
using BtkAkademi.Service.OrderAPI.Messages;
using Newtonsoft.Json;

namespace BtkAkademi.Service.OrderAPI.Messaging
{
